...
(function() {
  var body, collide, debug, find_centroid, force_g, force_g_offsetX, force_g_offsetY, get_translate, init_pop_data, init_power_data, label_container, log, max_size, min_size, move_to, pack_g, pack_g_offsetX, pack_g_offsetY, pop_format, power_format, power_scale, rotate, scale_to, svg;
  ...
  d3.json("data.json", function(err, data) {
    var cur_depth, cur_stage, first_run, force, force_data, force_labels, force_nodes, last_force_data, pack, pack_data, pack_nodes, pop_data, pop_label_links, pop_label_links_data, pop_labels, power_data, update, update_force_node, update_pack_node;
    ...
    update_force_node = function() {
      ...
      force_nodes.enter().append("g").attr("class", "force node").append("circle").attr("id", function(d) {
        return d.id;
      }).transition().duration(first_run ? 0 : 1000).tween('force_r_enter', function(d) {
        var i;
